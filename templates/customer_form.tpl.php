	...
	<form action="" method="post">
		<fieldset>
			<legend>Kliento informacija</legend>
				<p>
					...
					<?php if(!isset($data['editing'])) { ?>
						<input type="text" id="asmens_kodas" name="asmens_kodas" class="textbox-150" value="<?php echo isset($data['asmens_kodas']) ? $data['asmens_kodas'] : ''; ?>" />
			...
			<p>
				...
				<input type="text" id="gimimo_data" name="gimimo_data" class="textbox-70 date" value="<?php echo isset($data['gimimo_data']) ? $data['gimimo_data'] : ''; ?>" />
			</p>
			<p>
				<label class="field" for="telefonas">Telefonas<?php echo in_array('telefonas', $required) ? '<span> *</span>' : ''; ?></label>
				<input type="text" id="telefonas" name="telefonas" class="textbox-150" value="<?php echo isset($data['telefonas']) ? $data['telefonas'] : ''; ?>" />
			</p>
			<p>
				<label class="field" for="epastas">Elektroninis paštas<?php echo in_array('epastas', $required) ? '<span> *</span>' : ''; ?></label>
				<input type="text" id="epastas" name="epastas" class="textbox-150" value="<?php echo isset($data['epastas']) ? $data['epastas'] : ''; ?>" />
			</p>
		</fieldset>
