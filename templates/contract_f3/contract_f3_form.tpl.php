				...
				foreach($data['uzsakytos_paslaugos'] as $key => $orderedService) {
					echo
						"<tr>"
							...
							. "<a href='index.php?module={$module}&action=service_edit&contractId={$data['nr']}&serviceId={$orderedService['fk_paslauga']}&dateFrom={$orderedService['fk_kaina_galioja_nuo']}'>peržiūrėti</a>"
							. "</td>"
						. "</tr>";
				}
			?>
