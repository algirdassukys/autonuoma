        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
				    ...
				    <li class="nav-item"><a class="nav-link <?php if($module == 'contract_f3') { echo 'active'; } ?>" aria-current="page" href="index.php?module=contract_f3&action=list">Sutartys F3</a></li>
